...
export default function StudioQuiz() {
  ...
  if (materialLoading || questionsLoading) {
    return (
      <StudentLayout>
  ...
  if (!material || !questions || questions.length === 0) {
    return (
      <StudentLayout>
        ...
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <Card className="border-secondary/20 bg-secondary/5">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-muted-foreground text-lg mb-6">Punteggio ottenuto: {result.score} / {result.total}</p>
              ...
              <Card key={i} className={ans.correct ? "border-green-200" : "border-destructive/30"}>
                <CardContent className="p-6">
                  <div className="flex gap-4">
                    <div className="mt-1">
                      {ans.correct ? <CheckCircle2 className="h-6 w-6 text-green-500" /> : <XCircle className="h-6 w-6 text-destructive" />}
                    </div>
          ...
          <Card>
            <CardContent className="p-8 space-y-6">
              <div className="text-center space-y-2">
                ...
                <p className="text-muted-foreground">{questions.length} domande a risposta aperta.</p>
              </div>
