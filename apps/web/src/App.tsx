...
import CattedraRegistro from "./pages/CattedraRegistro";
import CattedraScrutinio from "./pages/CattedraScrutinio";
import CattedraStudente from "./pages/CattedraStudente";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/cattedra/registro/studente/:id">
        <TeacherGate>
          <CattedraStudente />
        </TeacherGate>
      </Route>
      <Route path="/cattedra/scrutinio">
        <TeacherGate>
          <CattedraScrutinio />
        </TeacherGate>
      </Route>
      <Route path="/cattedra/registro">
        <TeacherGate>
          <CattedraRegistro />
        </TeacherGate>
      </Route>
      ...
      <Route path="/cattedra/material/:id/domande">
        <TeacherGate>
          <CattedraDomande />
        </TeacherGate>
      </Route>
      ...
      <Route path="/studio/material/:id/tutor">
        <StudentGate>
          <StudioTutor />
        </StudentGate>
      </Route>
